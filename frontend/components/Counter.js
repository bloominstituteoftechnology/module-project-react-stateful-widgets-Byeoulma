...
export default function Counter() {
  /* STEP 1 */
// set up a state hook for [count, setCount] while count state is 0
const [count, setCount] = useState(0)
  ...
  const style = {
    ...
    marginBottom: '0.3em',
    /* STEP 2 */
    // using a ternary expression  if count is even 'royalblue' if count is odd then 'crimson'
  ...
  return (
    <div className='widget-counter container'>
      ...
      <div id='count' style={style}>
        {/* turning the 0 into the 'count' variable and setting the 'even' to be able to update as incre or decre*/}
